package org.springcloud.config2;
...
public class ConfigServerApplication2 extends WebMvcConfigurerAdapter implements CommandLineRunner {
	
	private Logger logger = LoggerFactory.getLogger(ConfigServerApplication2.class);
