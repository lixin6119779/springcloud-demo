package org.springcloud.eureka2.filter;
...
import org.springcloud.eureka2.jwt.Jwt;
import org.springcloud.eureka2.jwt.TokenState;
...
public class CheckTokenFilter  implements Filter {
	...
	static {
		...
		NOT_FILTER_URLS_CONTAINS.put("eureka", "eureka-server");
		NOT_FILTER_URLS_CONTAINS.put("1001", "1001");
	}
